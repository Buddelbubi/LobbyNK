...
import de.buddelbubi.implementedcode.network.scoreboard.map.Long2ObjectArrayMap;
import de.buddelbubi.implementedcode.network.scoreboard.network.packet.RemoveObjectivePacket;
import de.buddelbubi.implementedcode.network.scoreboard.network.packet.SetObjectivePacket;
import de.buddelbubi.implementedcode.network.scoreboard.network.packet.SetScorePacket;
...
public class Scoreboard {
    ...
    long addOrUpdateEntity( Entity entity, String objective, int score ) {
        ...
        // Add this score
        long newId = this.scoreIdCounter++;
        ScoreboardLine scoreboardLine = new ScoreboardLine( (byte) ( ( entity instanceof Player ) ? 1 : 2 ), (int) entity.getId(), "", objective, score );
        this.scoreboardLines.put( newId, scoreboardLine );
    ...
    private class ScoreboardLine {
        public ScoreboardLine(byte b, int i, String line2, String objective2, int score2) {
			type = b;
			entityId = i;
			line = line2;
